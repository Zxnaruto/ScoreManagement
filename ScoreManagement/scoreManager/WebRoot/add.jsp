...
<html>
 ...
 <center>
   <form action="score!add" method="post">
      ...
      <p>添加学生考试信息</p>
      <p>学号：<input type="text" name=score.stuNo></p>
      <p>姓名：<input type="text" name=score.stuName></p>
      <p>平时：<input type="text" name=score.dailyScore></p>
      <p>考试：<input type="text" name=score.examScore></p>
      <p>班级：
